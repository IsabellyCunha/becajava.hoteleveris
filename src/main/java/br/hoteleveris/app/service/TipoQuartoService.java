...
public class TipoQuartoService extends BaseResponse{
	...
	public BaseResponse inserir(TipoQuartoRequest tipoQuartoRequest) {
		...
		if(tipoQuartoRequest.getDescricao().trim().equals("") || tipoQuartoRequest.getDescricao().equals("string")) {//no swagger, por padrao, o "rótulo" dos campos fica com "string" escrito, então impedi que seja inserido no banco um cliente com dados escritos string
			base.Message = "A descrição do tipo de quarto deve ser preenchido";
			return base;
		}
		if(tipoQuartoRequest.getValor() == null) {//no swagger, por padrao, o "rótulo" dos campos fica com "string" escrito, então impedi que seja inserido no banco um cliente com dados escritos string
			base.Message = "Digite um valor válido!";
			return base;
		}
		...
		base.StatusCode = 201;
		base.Message = "Tipo de quarto inserido com sucesso.";
		return base;
	}
	...
	public TipoQuartoResponse obter(Long id) {
		...
		response.Message = "Tipo de quarto obtido com sucesso obtido com sucesso";
	...
	public BaseResponse atualizar(Long id, TipoQuartoRequest tipoQuartoRequest) {
		...
		if(tipoQuartoRequest.getValor() == null || tipoQuartoRequest.getValor() <= 0) {//no swagger, por padrao, o "rótulo" dos campos fica com "string" escrito, então impedi que seja inserido no banco um cliente com dados escritos string
			base.Message = "Digite um valor válido!";
			return base;
		}
		...
		base.StatusCode = 201;
		base.Message = "Tipo de quarto atualizado com sucesso.";
		return base;
	}
	...
	public BaseResponse deletar(Long id) {
		...
		response.StatusCode = 200;
		response.Message = "Tipo de quarto excluído com sucesso";
		return response;
	}
}
